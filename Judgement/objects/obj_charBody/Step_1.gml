...
if ((place_meeting(x,y,obj_skeleton)) or (place_meeting(x,y,obj_goblin)) or (place_meeting(x,y,obj_ghost)) or (place_meeting(x,y,obj_skullprojectile)) or (place_meeting(x,y,obj_fireball))) and (hit == 0)
{
