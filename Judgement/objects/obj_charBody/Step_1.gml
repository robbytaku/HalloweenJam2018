...
if ((place_meeting(x,y,obj_skeleton)) or (place_meeting(x,y,obj_goblin)) or (place_meeting(x,y,obj_ghost)) or (place_meeting(x,y,obj_skullprojectile)) or (place_meeting(x,y,obj_fireball)) or (place_meeting(x,y,obj_boss)) or (place_meeting(x,y,obj_goblinmansion3))) and (hit == 0) and (dead == false)
{
